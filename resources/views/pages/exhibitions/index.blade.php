    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">@lang('datatables.backend.exhibitions.title')
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('exhibitions.create')}}" class="btn btn-primary font-weight-bolder">
                <span class="svg-icon svg-icon-md">
                    ...
                    <!--end::Svg Icon-->
                </span>@lang('buttons.backend.general.crud.create') @lang('datatables.backend.exhibitions.title')</a>
                <!--end::Button-->
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover" id="kt_datatable">
                ...
                <tr>
                    <th></th>
                    <th>@lang('datatables.backend.list.exhibitions.name')</th>
                    <th>@lang('datatables.backend.list.exhibitions.detail')</th>
                    <th>@lang('datatables.backend.list.exhibitions.address')</th>
