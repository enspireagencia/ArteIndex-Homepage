										...
										<tbody>
											...
											<tr>
												...
												<td align="left" style="color:#444444;border-collapse:collapse;font-size:11pt;font-family:proxima_nova,'Open Sans','Lucida Grande','Segoe UI',Arial,Verdana,'Lucida Sans Unicode',Tahoma,'Sans Serif';max-width:454px" valign="top" width="454">
													<p>Hello,</p>
													<p>{{$data['user_name']}} (<a href="{{$data['sender_mail']}}" target="_blank">{{$data['sender_mail']}}</a>) has invited you to view a Document
														<b>{{$data['name']}}</b> on Arte Index.
													</p>
                                                    ...
                                                    @endif
													<br>
														<a href="{{$data['url']}}" style="border-radius:5px;font-size:14px;color:white;text-decoration:none;padding:12px 4px 12px 4px;width:150px;max-width:150px;font-family:proxima_nova,'Open Sans','lucida grande','Segoe UI',arial,verdana,'lucida sans unicode',tahoma,sans-serif;margin:12px auto;display:block;background-color:#008cba;text-align:center" target="_blank" >View Document</a>
													</td>
													<td width="36"></td>
												</tr>
												<tr>
