										...
										<tbody>
											...
											<tr>
												...
												<td align="left" style="color:#444444;border-collapse:collapse;font-size:11pt;font-family:proxima_nova,'Open Sans','Lucida Grande','Segoe UI',Arial,Verdana,'Lucida Sans Unicode',Tahoma,'Sans Serif';max-width:454px" valign="top" width="454">
                                                    ...
                                                    <p>You just received a new inbound piece inquiry from {{$data['name']}} on your Private Room.</p>
                                                    ...
                                                    @endif
													<br>
													<a href="{{$data['view_message_url']}}" style="border-radius:5px;font-size:14px;color:white;text-decoration:none;padding:12px 4px 12px 4px;width:150px;max-width:150px;font-family:proxima_nova,'Open Sans','lucida grande','Segoe UI',arial,verdana,'lucida sans unicode',tahoma,sans-serif;margin:12px auto;display:block;background-color:#008cba;text-align:center" target="_blank" >View this message</a>
													<br>
													<a href="{{$data['view_inbox_url']}}" style="border-radius:5px;font-size:14px;color:white;text-decoration:none;padding:12px 4px 12px 4px;width:150px;max-width:150px;font-family:proxima_nova,'Open Sans','lucida grande','Segoe UI',arial,verdana,'lucida sans unicode',tahoma,sans-serif;margin:12px auto;display:block;background-color:#008cba;text-align:center" target="_blank" >View your inbox.</a>
													</td>
													<td width="36"></td>
												</tr>
												<tr>
