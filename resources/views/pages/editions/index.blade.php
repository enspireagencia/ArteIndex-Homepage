    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Editions
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('editions.create')}}" class="btn btn-primary font-weight-bolder">
                <span class="svg-icon svg-icon-md">
                    ...
                    <!--end::Svg Icon-->
                </span>@lang('buttons.backend.general.crud.create') Edition</a>
                <!--end::Button-->
            </div>
        </div>
...
@section('scripts')
    ...
    var table = $('#kt_datatable').DataTable({
        ...
        function editionsDelete(id) {
            Swal.fire({
                title: "Do you want to delete the this edition?",
