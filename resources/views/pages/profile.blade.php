         ...
         <div class="card card-custom gutter-b">
            <div class="card-header border-0 pt-6 mb-2">
               <h3 class="card-title align-items-start flex-column">
                  <span class="card-label font-weight-bold font-size-h2 text-dark-75 mb-3">{{$data->name ?? ""}}</span>
               </h3>
               <div class="card-toolbar">
                  <a href="#" data-toggle="modal" data-target="#sendProfileInquiry"  class="btn btn-light-primary btn-sm font-weight-bolder font-size-sm py-3 px-6">Message</a>
               </div>
            </div>
         </div>
               ...
               <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                  <li class="nav-item mr-3">
                     <a class="nav-link active" data-toggle="tab" href="#kt_apps_contacts_view_tab_2">
                        ...
                        <span class="nav-text font-weight-bold">Portfolio</span>
                     </a>
                  </li>
                  <li class="nav-item mr-3">
                     <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_3">
                        ...
                        <span class="nav-text font-weight-bold">News</span>
                     </a>
                  </li>
               </ul>
            </div>
         ...
         <div class="card-body">
            <div class="tab-content pt-5">
               <div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                              ...
                              <div class="card-body p-0">
                                 <div class="overlay-wrapper">
                                    @php
                                       ...
                                       if(isset($piece->pieces_images[0]->url)){
                                             $thumimage=asset_image_display($piece->pieces_images[0]->url,"images/pieces/");
                                       }
                                    @endphp
                                    <img style="background-image:url('{{$thumimage}}')" alt="" class="background_img rounded" >
                                 </div>
                                 <div class="overlay-layer">
                                    <a href="{{route('profile.pieces_detail',[$data->user_unique_id,$piece->slug])}}" class="font-size-h4 font-weight-bolder text-white text-hover-primary">{{$piece->title}}</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     @else
                     <div class="text-center text-muted font-size-h2 font-weight-bold"><b>No Pieces</b></div>
                     <div class="row">
										<div class="offset-md-3 col-md-6">
											<span class="svg-icon svg-icon-full">
												...
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="a26a8f0d-4f9c-4927-88fb-2c6a33da07b1" data-name="Layer 1" width="1167.52" height="754.06" viewBox="0 0 1167.52 754.06">
													<g opacity="0.2">
														<path d="M1023.5,799.4a18.25,18.25,0,0,1-1.73,2.67q-8.64-6.09-17.57-11.93c.12-.25.25-.51.39-.77a16.74,16.74,0,0,1,6-6.51c3.29-2,7-2.48,10-.86s4.76,4.93,4.94,8.77A16.85,16.85,0,0,1,1023.5,799.4Z" transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
														<ellipse cx="1022.06" cy="779.24" rx="14.01" ry="10.7" transform="translate(-161.16 1244.78) rotate(-62.09)" fill="#3f3d56"></ellipse>
														<ellipse cx="1030.07" cy="764.11" rx="14.01" ry="10.7" transform="translate(-143.52 1243.81) rotate(-62.09)" fill="#3f3d56"></ellipse>
														<ellipse cx="1038.09" cy="748.97" rx="14.01" ry="10.7" transform="translate(-125.88 1242.84) rotate(-62.09)" fill="#3f3d56"></ellipse>
														<ellipse cx="1046.11" cy="733.84" rx="14.01" ry="10.7" transform="translate(-108.24 1241.87) rotate(-62.09)" fill="#3f3d56"></ellipse>
														...
														<path d="M1131.64,682.38a51.13,51.13,0,0,1-24.53,22.88,51.28,51.28,0,1,1-71.23-37.73C1033.89,656.61,1134.34,677.29,1131.64,682.38Z" transform="translate(-16.24 -72.97)" opacity="0.1"></path>
													</g>
													<g opacity="0.2">
														<path d="M991.37,496.93a31,31,0,0,1-2.25,4.63Q974,493.51,958.51,485.9c.14-.43.3-.87.47-1.31a27.32,27.32,0,0,1,8.3-11.66c4.87-3.9,10.74-5.37,16-3.38s8.62,7,9.67,13.12A27.21,27.21,0,0,1,991.37,496.93Z" transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
														<ellipse cx="985.03" cy="464.84" rx="22.69" ry="17.33" transform="translate(183.96 1147.12) rotate(-69.16)" fill="#3f3d56"></ellipse>
														<ellipse cx="994.89" cy="438.92" rx="22.69" ry="17.33" transform="translate(214.54 1139.64) rotate(-69.16)" fill="#3f3d56"></ellipse>
														<ellipse cx="1004.76" cy="413.01" rx="22.69" ry="17.33" transform="translate(245.11 1132.16) rotate(-69.16)" fill="#3f3d56"></ellipse>
														<ellipse cx="1014.62" cy="387.09" rx="22.69" ry="17.33" transform="translate(275.69 1124.68) rotate(-69.16)" fill="#3f3d56"></ellipse>
														...
														<path d="M1141.79,287.38A82.63,82.63,0,0,1,1106.93,329a83,83,0,1,1-122-46.42C979.6,265.45,1145.11,278.67,1141.79,287.38Z" transform="translate(-16.24 -72.97)" opacity="0.1"></path>
													</g>
													<g opacity="0.2">
														<path d="M194.62,583.14a37.65,37.65,0,0,0,2,5.8q19-7.29,38.43-14c-.11-.53-.22-1.07-.36-1.62a32.46,32.46,0,0,0-8.07-15c-5.18-5.32-11.89-7.92-18.34-6.34s-11.2,7-13.35,14.05A32.48,32.48,0,0,0,194.62,583.14Z" transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
														<ellipse cx="206.83" cy="546.21" rx="20.61" ry="26.98" transform="translate(-139.85 -8.35) rotate(-13.72)" fill="#3f3d56"></ellipse>
														<ellipse cx="199.01" cy="514.17" rx="20.61" ry="26.98" transform="translate(-132.48 -11.12) rotate(-13.72)" fill="#3f3d56"></ellipse>
														<ellipse cx="191.2" cy="482.14" rx="20.61" ry="26.98" transform="translate(-125.1 -13.89) rotate(-13.72)" fill="#3f3d56"></ellipse>
														<ellipse cx="183.38" cy="450.11" rx="20.61" ry="26.98" transform="translate(-117.73 -16.66) rotate(-13.72)" fill="#3f3d56"></ellipse>
														...
														<path d="M48,313.7A98.3,98.3,0,0,0,83,368a98.72,98.72,0,1,0,150.76-36.79C242.64,311.73,45.39,302.93,48,313.7Z" transform="translate(-16.24 -72.97)" opacity="0.1"></path>
													</g>
													<path d="M1072.54,186.69H103.8a8.64,8.64,0,0,0-8.63,8.65V788.23a17.43,17.43,0,0,0,17.4,17.46h951.2a17.43,17.43,0,0,0,17.4-17.46V195.34A8.64,8.64,0,0,0,1072.54,186.69Z" transform="translate(-16.24 -72.97)" fill="url(#ab1c7cfe-44b5-4159-9f4a-9e5eb45dcf3d)"></path>
													<path d="M1077.25,223.5V784.74A17.26,17.26,0,0,1,1060,802H116.51a17.26,17.26,0,0,1-17.26-17.26V223.5Z" transform="translate(-16.24 -72.97)" fill="#fff"></path>
													<path d="M228.17,216.69V802H116.51a17.26,17.26,0,0,1-17.26-17.26v-568Z" transform="translate(-16.24 -72.97)" fill="#d7d9e1"></path>
													<path d="M1077.25,198.56V223.5h-978V198.56a8.56,8.56,0,0,1,8.56-8.56h960.88A8.56,8.56,0,0,1,1077.25,198.56Z" transform="translate(-16.24 -72.97)" fill="#ededf4"></path>
													...
8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.69-19.74Z" transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
													<circle cx="882.39" cy="741.63" r="12.43" fill="#3f3d56"></circle>
													<circle cx="882.39" cy="741.63" r="7.87" fill="#65617d"></circle>
													<path d="M889.1,795.12l8.16,18.44a1.58,1.58,0,0,0,2.87.06l9.69-19.74Z" transform="translate(-16.24 -72.97)" fill="#3f3d56"></path>
													<rect x="787.93" y="633.71" width="82" height="82" fill="#ededf4"></rect>
													<path d="M820.85,742.48h13.9v20.84h-13.9Zm17.37-10.42h13.89v31.26H838.22Zm17.37,17.36h13.89v13.9H855.59Z" transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
													<rect x="801.93" y="551.71" width="82" height="82" fill="#d7d9e1"></rect>
													<path d="M845.27,683.05h27.79v5.21H845.27Zm13.9-13.89a3.48,3.48,0,0,0,0-6.95,3.83,3.83,0,0,0-1,.13L851,657.06l-.43.38,5.31,7.24a3.29,3.29,0,0,0-.16,1A3.47,3.47,0,0,0,859.17,669.16Z" transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
													...
													<path d="M420.48,453.85h6.95v41.68h-6.95Zm-10.42,29.52H417v12.16h-6.95Zm20.84-6.95h7v19.11h-7ZM441.32,466h6.95v29.53h-6.95Z" transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
													<rect x="817.93" y="361.71" width="82" height="82" opacity="0.1"></rect>
													<rect x="815.93" y="359.71" width="82" height="82" fill="#ededf4"></rect>
													<path d="M886.56,465.25l-9.47,14.48a5.13,5.13,0,0,1,1.17,3.28,5.21,5.21,0,0,1-10.42,0,6.12,6.12,0,0,1,.09-1l-6.25-3.64a5.19,5.19,0,0,1-6.18.78l-6.65,6.23v6.21a4.65,4.65,0,0,0,4.63,4.64h39.37a4.66,4.66,0,0,0,4.64-4.64V468.56l-6.36-4.23a5.23,5.23,0,0,1-4.57.92Z" transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
													...
													<path d="M637.27,495.05h27.79v5.21H637.27Zm13.9-13.89a3.48,3.48,0,0,0,0-7,3.83,3.83,0,0,0-1,.13L643,469.06l-.43.38,5.31,7.24a3.29,3.29,0,0,0-.16,1A3.47,3.47,0,0,0,651.17,481.16Z" transform="translate(-16.24 -72.97)" fill="#6c63ff"></path>
               ...
               <div class="tab-pane" id="kt_apps_contacts_view_tab_3" role="tabpanel">
                  @if(isset($posts) && count($posts)>0)
                           ...
                           <div class="card card-custom gutter-b card-stretch ">
                              <div class="card-body text-center pt-4">
                                 <div class="mt-7">
                                    ...
                                    @endphp
                                       <img class="width-100" src="{{$thumimage}}" alt="image">
                                    </div>
                                 </div>
                                 <div class="my-4">
                                    <a href="{{route('profile.post_detail',[$data->user_unique_id,$post->slug])}}" class="text-dark font-weight-bold text-hover-primary font-size-h4">{{$post->title}}</a>
                                    <div class="text-muted">{{$post->subheader}}</div>
                                 </div>
                                 <span class="btn btn-text btn-light-success btn-sm font-weight-bold">{{date('F Y',strtotime($post->created_at)) ?? ""}}</span>
                              </div>
                           </div>
                        </div>
                     @endforeach
                     ...
                     @else
                     <div class="text-center text-muted font-size-h2 font-weight-bold"><b>No Posts</b></div>
                     <div class="row">
										<div class="offset-md-3 col-md-6">
											<span class="svg-icon svg-icon-full">
												<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/illustrations/data-points.svg-->
...
<div class="modal fade" id="sendProfileInquiry" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" enctype="multipart/form-data" method="post" id="sendinquiryForm">
               <input  name="profile_slug" id="profile_slug" value="{{$data->user_unique_id}}" type="hidden">
...
//submit inquiry form
   ...
   $("#inquirypieces").on("click", function(event){
      ...
      $("#sendinquiryForm").on("submit", function(event){
         ...
         $.ajax({
				url: "{{ route('pieces_profile_inquiry') }}",
				method: 'POST',
				data: formData,
				contentType: false,
				cache: false,
