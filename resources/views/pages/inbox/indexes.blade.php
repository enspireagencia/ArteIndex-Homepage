...
@section('content')
    <div class="card card-custom">
        ...
        <div class="archive ml-8 row">
          ...
          <div class="col-2">
            <select class="form-control form-control-solid ml-3">
                <option selected value="{{ route('inbox.inboxex')}}"> @lang('datatables.backend.list.inbox.archive') </option>
                <option value="{{ route('inbox.index')}}"> @lang('datatables.backend.list.inbox.active') </option>
            </select>
          </div>
        </div>
        <div class="card-body">
