               ...
               <div class="card-body p-15 pb-20">
                  ...
                  <div class="row mb-17">
                     <div class="col-sm-5 mb-11 mb-xxl-0">
                        ...
                        <div class="card card-custom card-stretch">
                           <div class=" test_image d-flex align-items-center overlay-wrapper parent-container">
                                @php
                     ...
                     <div class="col-sm-7 pl-xxl-11">
                        ...
                        <span class="mt-9 mb-6 fb-share-button">
                           <span class="fb-share-button" data-href="{{route('profile.pieces_detail',[$data->user_unique_id,$pieces->slug])}}" data-layout="button" data-size="large">
                              <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{route('profile.pieces_detail',[$data->user_unique_id,$pieces->slug])}}" class="fb-xfbml-parse-ignore btn btn-md btn-icon btn-light-facebook btn-pill mx-2">
                                 <i class="socicon-facebook"></i>
                              </a>
                           </span>
                           <a target="_blank" class="btn btn-md btn-icon btn-light-twitter btn-pill mx-2 twitter-share-button" href="https://twitter.com/intent/tweet?url={{route('profile.pieces_detail',[$data->user_unique_id,$pieces->slug])}}" data-size="large">
                              <i class="socicon-twitter"></i>
                           </a>
                           <a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url={{route('profile.pieces_detail',[$data->user_unique_id,$pieces->slug])}}" class="btn btn-md btn-icon btn-light-linkedin btn-pill mx-2">
                  ...
                  <div class="row mb-6">
                     ...
                     <div class="col-6 col-md-4">
                        ...
                        @if(isset($pieces->wholesale_price))
                        <div class="col-6 col-md-4">
                           <div class="mb-8 d-flex flex-column">
                     ...
                     @endif
                     @if(isset($pieces->subject_matter))
                     <div class="col-6 col-md-4">
                        <div class="mb-8 d-flex flex-column">
                     ...
                     @if(isset($pieces->inventory_number))
                     <div class="col-6 col-md-4">
                        <div class="mb-8 d-flex flex-column">
                     ...
                     <div class="col-lg-12 col-md-9 col-sm-12">
                        <div class="form-group row">
                           <div class="col-lg-12">
                              ...
                              <input  name="room_slug" id="room_slug" value="{{$pieces->slug}}" type="hidden">
